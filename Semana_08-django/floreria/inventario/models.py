...
class ProductoModel(models.Model):
    ...
    almacenId = models.ForeignKey(
        ...
        #related_name = para ingresar a su  relación inversa, es decir cuando querramos saber todos los
        #productoas que tienen un almacen en, especifico, si no se otorga un nombre,django le pondra uno
        #aleatorio usando un formato establecido:usara el nombre del nombre con el sufijo _set =>
